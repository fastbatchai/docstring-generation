...
class Perplexity(evaluate.EvaluationModule):
    """
    Modified version of perplexity. For more information, see https://huggingface.co/docs/transformers/perplexity
    The original implementation accepets model_id as input, but this implementation modifies it to accept model and tokenizer as input.
    """
